 ...
 <div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <h2>Select Item and Area</h2>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for ItemNames.." title="Type in a name">
<form action="uvendorsearch.html" >
<table id="myTable">
  <tr class="header">
    <th style="width:40%;">Item Name</th>
    <th style="width:40%;">Select</th>
        <th style="width:40%;">Select Area</th>
  </tr>
  <tr>
    <td>Paper</td>
    <td><input type="checkbox" name="item1" value="Paper" ></td> <td rowspan="6">
...
<select class="form-control"  name="area" required>
  ...
  <tr>
    <td colspan="3"><input type="submit" value="Search For Vendor"></td>
