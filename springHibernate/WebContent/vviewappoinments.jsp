...
<%--     <h3 align="center">${msg}</h3> --%>
      <h1 align="center"> Booked Appoinments </h1>
<h1></h1>
<h1></h1>
<div class="container">
<table id="myTable">
 ...
 <th style="width:20%;">User Name</th>
  <th style="width:20%;">Item Name</th>
    <th style="width:20%;"> Qty Range</th>
    <th style="width:20%;">Price / kg</th>
     <th style="width:20%;">Address</th>
      <th style="width:20%;">Time</th>
    <th style="width:20%;">MobNo</th>
  </tr>

<% 

List<Appointment> l=(List<Appointment>)ses.getAttribute("vap");

for(int i=0;i<l.size();i++) { %>
   <tr>

        <td><%=l.get(i).getBdate()%></td>  <td><%=l.get(i).getUserName()%> </td><td><%=l.get(i).getItemName()%> </td><td><%=l.get(i).getQtyRange()%> </td><td><%=l.get(i).getPrice()%> </td>
    <td><%=l.get(i).getAddress()%> </td><td><%=l.get(i).getTime()%></td> <td><%=l.get(i).getMobNo()%> </td>
    </tr>
<% } %>
</table>
</div>
