...
<!--         <li class="tab "><a href="forgotemail.jsp">Forgot Email</a></li>  -->
      ...
      <div id="#login">   
          <h1 style="color: white;">Provide UserName</h1>
          
          <form action="vforgotpass.html" method="post">
            ...
            <input type="text" name="vname" placeholder="Vendor Name" required autocomplete="off" style="color: white;"/>
          </div>
