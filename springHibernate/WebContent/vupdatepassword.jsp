...
<div class="form">
      ...
      <ul class="tab-group">
<!--        // <li class="tab "><a href="vlogin.jsp">Sign Up</a></li> -->
        <li class="tab active"><a href="#">Updated Password</a></li>
      </ul>
      ...
      <div id="#login">   
          ...
          <form action="vupdatepass.html" method="post">
          
            <div class="field-wrap">
            <label>
              <span class="req"></span>
            </label>
            <input type="password" name="pass" required autocomplete="off" style="color: white;" required/>
          </div>
