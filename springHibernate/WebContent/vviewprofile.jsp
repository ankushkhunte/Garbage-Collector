<%@page import="springHibernate.VendorRegisrtration"%>
...
<%--     <h3 align="center">${msg}</h3> --%>
      <h1 align="left">Profile Details</h1>


<div class="container">
<table id="myTable">
 <tr class="header">
  <td colspan="2"><h2><span class="glyphicon glyphicon-user"></span>About</h2></td>
  
  </tr>

<% 

VendorRegisrtration l=(VendorRegisrtration)ses.getAttribute("vendor"); %>


  

        <tr> <td>Vendor Name :</td>  <td> <%=l.getVendorName()%>  </td></tr>
        <tr> <td> Email :</td>    <td> <%=l.getEmail()%> </td></tr>
        <tr> <td>Mobile No :</td>  <td> <%=l.getMobNo()%>  </td></tr>
        <tr> <td>City :</td>  <td> <%=l.getCity()%> </td></tr>
        <tr>  <td>ZipCode :</td>  <td> <%=l.getZipCode()%> </td></tr>
