...
public class VitemSaveController4 implements Controller {
...
//			arr.addAll(dao.getMember());
		...
		ses.setAttribute("itemname4",itemName);
			return new ModelAndView("vsame4","msg"," Details added Sucessfully");
		}
