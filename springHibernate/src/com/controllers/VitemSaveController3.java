...
public class VitemSaveController3 implements Controller {
...
//			arr.addAll(dao.getMember());
		...
		ses.setAttribute("itemname3",itemName);
			return new ModelAndView("vsame3","msg"," Details added Sucessfully");
		}
}
