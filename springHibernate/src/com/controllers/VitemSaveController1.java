 ...
 *
 */
public class VitemSaveController1 implements Controller {
...
//			arr.addAll(dao.getMember());
		...
		ses.setAttribute("itemname2",itemName);
			return new ModelAndView("vsame1","msg"," Details added Sucessfully");
		}
