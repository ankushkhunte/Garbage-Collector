...
public class VitemSaveController5 implements Controller{
...
//			arr.addAll(dao.getMember());
		...
		ses.setAttribute("itemname5",itemName);
			return new ModelAndView("vsame5","msg"," Details added Sucessfully");
		}
}
